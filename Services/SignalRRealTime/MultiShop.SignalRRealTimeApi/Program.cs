...
{
    opt.AddPolicy("CorsPolicy", builder =>   // baþka siteye istek atmasýný saglýyoruz gezerken sürekli  navbar için istek atýcaz ...
    {
...
app.MapHub<SignalRHub>("/signalrhub"); //localhost://1234/category/index
